                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td><b><?php echo strtoupper( $row['firstname'].'  '.$row['lastname']); ?></b></td>
                          ...
                          <td>
                            ...
                            <button class="btn btn-sm btn-outline-primary view btn-flat" data-id="<?php echo $row['empid']; ?>"><i class="fa fa-eye"></i> View</button>
                          </td>
                        </tr>
                      <?php
                    }
